...
<c:choose>
	<c:when test="${not empty principal}">
		...
		<h4><a href="${cPath }/mypage">${principal.realUser.memName }</a> <a class="btn btn-danger" href="javascript:;" id="logoutBtn">로그아웃</a></h4>
...
<H4>검색된 메시지 : <spring:message code="hi" arguments="반장"></spring:message></H4>
